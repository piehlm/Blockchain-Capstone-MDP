...
contract Ownable {
    ...
    modifier onlyOwner()
    {
        require(msg.sender == _owner,"Must be called by contract owner.");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(Address.isContract(newOwner),"New address is not a contract.");
        address old = _owner;
        _owner = newOwner;
...
//  2) create a public setter using the inherited onlyOwner modifier
    ...
    {
        require(state != _paused,"State is the same as current state.");
        _paused = state;
        if(state)
...
contract ERC165 {
    ...
    function _registerInterface(bytes4 interfaceId) internal {
        require(interfaceId != 0xffffffff, "Incorrect interface ID");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "Owner and new address are the same");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(ownerOf(tokenId) == msg.sender, "Must be the owner to transfer the token");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == address(0),"Owner for this tokenId already exists!");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from,"Not the owner for this tokenId!");
        // TODO: require token is being transfered to valid address
        require(from != address(0),"from address cant be NULL");
        require(to != address(0),"to address is NULL");
        // TODO: clear approval
...
contract MDPERC721Token is ERC721Metadata("capstone", "MDP", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
